package com.sanzee.reactive_kafka_playground.sec10_parallel_flatMap;
...
public class KafkaConsumer {
    ...
    public static void main(String[] args) {
        ...
        KafkaReceiver.create(option)
                .receiveAutoAck()
                .log()
                .flatMap(KafkaConsumer::batchProcessing, 256)
                .subscribe();

    }

    private static Mono<Void> batchProcessing(Flux<ConsumerRecord<Object, Object>> flux) {
        return flux
